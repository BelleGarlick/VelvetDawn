...
public class TestSetup extends BaseTest {
    ...
    public void test_place_setup_entity() throws Exception {
        ...
        assertThrows(Exception.class, () -> {
            velvetDawn.game.setup.placeEntity(p1, "civil-war:commander",  new Coordinate(25, 0));
        });
        assertThrows(Exception.class, () -> {
            velvetDawn.game.setup.placeEntity(p1, "civil-war:musketeers",  new Coordinate(25, 0));
        });
        ...
        velvetDawn.game.setup.placeEntity(p1, "civil-war:commander", new Coordinate(24, 0));
        assertThrows(Exception.class, () -> {
            velvetDawn.game.setup.placeEntity(p1, "civil-war:commander", new Coordinate(26, 0));
        });
        assertThrows(Exception.class, () -> {
            velvetDawn.game.setup.removeEntity(p1, new Coordinate(26, 0));
        });
        velvetDawn.game.setup.removeEntity(p1, new Coordinate(24, 0));
        velvetDawn.game.setup.placeEntity(p1, "civil-war:commander", new Coordinate(26, 0));

        // Test placing and placing in same pos and placing too many
        velvetDawn.game.setup.placeEntity(p1, "civil-war:musketeers", new Coordinate(24, 1));
        // Placing two items in same cell
        assertThrows(Exception.class, () -> {
            velvetDawn.game.setup.placeEntity(p1, "civil-war:musketeers", new Coordinate(24, 1));
        });
        velvetDawn.game.setup.placeEntity(p1, "civil-war:musketeers", new Coordinate(23, 1));

        // too many places
        assertThrows(Exception.class, () -> {
            velvetDawn.game.setup.placeEntity(p1, "civil-war:musketeers", new Coordinate(24, 2));
        });

        // Test is not validated until player b has been setup
        assertFalse(velvetDawn.game.setup.validatePlayerSetups());

        velvetDawn.game.setup.placeEntity(p2, "civil-war:musketeers", new Coordinate(25, 49));
        velvetDawn.game.setup.placeEntity(p2, "civil-war:musketeers", new Coordinate(24, 49));
        velvetDawn.game.setup.placeEntity(p2, "civil-war:commander", new Coordinate(26, 49));
