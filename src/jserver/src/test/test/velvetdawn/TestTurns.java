...
public class TestTurns extends test.BaseTest {
    ...
    public void test_update_turn_start_time() throws Exception {
        var velvetDawn = this.prepareGame();
        var currentTurnStart = velvetDawn.game.turns.getTurnStart();
        ...
        assertEquals(
                ...
                Math.round(velvetDawn.game.turns.getTurnStart()));

        assertNotEquals(
                currentTurnStart.longValue(),
                velvetDawn.game.turns.getTurnStart().longValue());
    }
